...
function testPreprocess(testCase)
    ...
    [list_of_pos, ~, ~] = preprocess_moore_traces(trace);
    ...
    testCase.verifyEqual(DFA1.A{1}(1,2),1);
    testCase.verifyEqual(DFA1.A{2}(2,3),1);
    testCase.verifyEqual(DFA1.A{3}(3,5),1);
    testCase.verifyEqual(DFA1.A{4}(3,4),1);
end